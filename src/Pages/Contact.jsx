                        ...
                        <div className='w-full md:w-[40%] mt-10 md:mt-[200px]'>
                            ...
                            <Flex className={'mt-10'}>
                                ...
                                <div className='ml-5'>
                                    ...
                                    <Paragraph pText={'info.mdkamruzzaman.dev@gmail.com'} className={'font-ops text-[20px] text-ff font-semibold md:text-[16px] lg:text-[20px] break-all sm:break-normal'} />
                                </div>
                            </Flex>
                            <Flex className={'mt-10'}>
