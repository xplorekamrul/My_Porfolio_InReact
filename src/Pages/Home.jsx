    ...
    <>
      ...
      <div className="py-[50px] bg-blackbg" id="home">
        <Container>
          ...
          <Flex
            className={
              "  justify-between mob:flex-col-reverse sm:flex-col-reverse tab:text-[30px]:flex-col-reverse tab:flex-col-reverse md:flex-row "
            }
          >
            <div className="w-[55%] pt-[100px] mob:w-full mob:mt-[50px]  sm:w-full sm:mt-10 sm:px-5 tab:w-full tab:px-8 md:w-[55%]">
              <Paragraph
                pText={"Font-End Developer."}
                className={
                  "font-pap font-regular text-ff text-[20px] mob:text-[16px] sm:text-[16px] mob:ml-5  leading-[30px] mob:leading-2 "
                }
              />
              ...
              <Paragraph
                pText={
                  "As a front-end web developer, I specialize in crafting responsive, user-friendly websites that bring ideas to life. Good design creates a great impression and drives business success. Let me help you turn your vision into a digital experience that leaves a lasting impact."
                }
                className={
                  " mob:mt-5 sm:mt-5 font-pap font-regular text-ff text-[16px] text-justify leading-[30px]  pr-[60px] mob:px-5 sm:pr-0"
                }
              />
              ...
              <Flex className={"mt-5 mob:px-5 flex-wrap "}>
                <a href="/mdkamruzzaman.pdf" download="/mdkamruzzaman.pdf">
                  <div className="flex mt-5 hover:mt-3 transition-all duration-300 ease-in  py-3 px-10 rounded-xl border border-gg w-[264px]  hover:bg-gg group hover:shadow-[0_0_10px_2px_rgba(34,197,94,0.6)]">
                    <Button
                      btnName={"Download cv"}
                      className={
                        "font-ops text-[20px] text-gg uppercase font-semibold group-hover:text-black "
                      }
                    />
                ...
                <a
                  href="https://www.linkedin.com/in/xplorekamrul/"
                  target="_blank"
                >
            ...
            <div className="w-[40%] mx-auto mt-6 sm:mt-6 md:mt-[200px] lg:mt-[220px] xl:mt-[80px] xl:w-[30%]">
              <HeroImag />
            </div>
          </Flex>
          ...
          <Flex
            className={
              "justify-evenly flex-wrap flex-col mt-[50px] px-5 sm:flex-row"
            }
          >
            <Flex className={`w-[250px] mt-10`}>
              <DynamicTextEffect
                textArray={["2"]}
                className={`font-cha font-semibold home-stroked-text text-ff text-[60px]  leading-[30px]
                `}
              />
              <span
                className={`font-ops font-semibold text-ff text-[40px] leading-[0px] pl-3 `}
              >
                +
              </span>
              <Paragraph
                pText={`Years of Experience.`}
                className={`font-ops font-semibold text-ff text-[20px]  leading-[30px]  pl-3 `}
              />
            </Flex>
