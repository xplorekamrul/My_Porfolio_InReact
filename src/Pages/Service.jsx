            ...
            <div className='bg-blackbg py-[50px] '>
                <Container>
                    <Flex className={'justify-center mt-10'}>
                        <Heading headingName={'My Ser'} className={'text-center font-ops font-bold text-ff text-[50px] leading-[80px] '} />
                        <Heading headingName={'vices.'} className={'text-center font-ops font-bold text-gg text-[50px] leading-[80px] '} />
                    </Flex>
                    <Flex className={'justify-between flex-wrap mt-[80px] mob:flex-col sm:flex-col md:flex-row'}>
                        <div className='group border-b-[3px] w-[45%] mob:w-full mob:p-5 sm:w-full sm:p-5 md:w-[45%]'>
                            <Flex className={'justify-between'}>
                                ...
                                <Link to="../Pages/Contact" target='_blank'>
                                    <BsArrowDownRight className={'text-black text-[50px] p-[5px] rounded-full bg-ff group-hover:bg-gg hover:-rotate-90'} />
                                </Link>
                            </Flex>
                            <Heading headingName={'Web Development'} className={'font-ops font-bold text-ff  hover:text-gg text-[50px] md:text-[45px] leading-[80px]'} />
                        ...
                        <div className='group border-b-[3px] w-[45%] mob:w-full mob:p-5 sm:w-full sm:p-5 md:w-[45%]'>
                            ...
                            <Heading headingName={'Ui/Ux Design'} className={'font-ops font-bold text-ff hover:text-gg text-[50px] leading-[80px]'} />
                        ...
                        <div className='group border-b-[3px] w-[45%] mt-10 mob:w-full mob:p-5 sm:w-full sm:p-5 md:w-[45%]'>
                            ...
                            <Heading headingName={'Logo Design'} className={'font-ops font-bold text-ff hover:text-gg text-[50px] leading-[80px]'} />
                        ...
                        <div className='group border-b-[3px] w-[45%] mt-10 mob:w-full mob:p-5 sm:w-full sm:p-5 md:w-[45%]'>
                            ...
                            <Heading headingName={'E-Mail Signature'} className={'font-ops font-bold text-ff hover:text-gg text-[50px] leading-[80px]'} />
