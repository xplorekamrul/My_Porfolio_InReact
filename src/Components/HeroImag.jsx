    ...
    return (
        <div className="w-full h-full relative flex justify-center items-center">
            ...
            >
                {/* Circle Animation */}
                <motion.svg
                    className="w-[300px] lg:w-[500px] h-[300px] lg:h-[500px]"
                    fill="transparent"
                    viewBox="0 0 506 506"
                    xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <motion.div
                    ...
                    className="absolute flex justify-center items-center w-[250px] h-[250px] lg:w-[400px] lg:h-[400px]"
                >
                    <Image
                        imgSrc={image}
                        priority
                        quality={100}
                        fill
                        className="object-contain w-full h-[114%] lg:h-[118%]"
                    />
                </motion.div>
            </motion.div>
        </div>
